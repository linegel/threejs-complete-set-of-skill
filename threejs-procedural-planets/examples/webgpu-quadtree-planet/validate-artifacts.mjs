...
const directory = resolve(index >= 0 ? process.argv[index + 1] : "artifacts/visual-validation/webgpu-quadtree-planet");
const result = validateEvidenceBundle(directory);
if (!result.valid) throw new Error(`planet v2 evidence incomplete:\n- ${result.errors.join("\n- ")}`);
