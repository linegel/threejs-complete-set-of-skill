...
// LEGACY WebGL2/GLSL reference. New teaching and validation live in
// ../webgpu-lut-atmosphere/; keep this file only for historical LUT math
// comparison and WebGL quarantine work.
...
const atmosphereFunctions = `
  ...
  vec3 skyRadiance(
    ...
    float topDiscriminant =
      ...
      radius * radius +
      uTopRadius * uTopRadius;
    if (radius > uTopRadius && topDiscriminant < 0.0) {
