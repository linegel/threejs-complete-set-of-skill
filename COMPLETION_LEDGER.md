...
| Capture policy | Playwright headless Chromium for deterministic correctness; Codex in-app Browser for physical-route and hardware-performance evidence |
...
| STAB-02 | Shared evidence contracts and source closures | STAB-01 | in-progress | `labs/runtime`, `labs/schema`, corpus/harness closure modules | focused schema/runtime tests | none | `f3e1b05`, `d29d122`, `d3acbd2` | capture-lane separation is being corrected; shared ownership/schema audit findings remain |
...
| ROUTE-01 | Generate complete 27-skill roster and router schema | GIT-01 | todo | `threejs-choose-skills` | route fixtures/mutations | router lab | pending | authoritative roster remains 27 skills |
...
| VALID-01 | Shared three-lane evidence runtime | GIT-01, PHYS-01 | in-progress | visual-validation harness | Playwright correctness plus immutable physical/performance runner tests | shared correctness runner + same-origin physical runner | `d29d122`, `e076180`, `d3acbd2`, `2b0b9ed` | lane policy correction, real sessions, and inspected images remain |
...
| TOWER-02 | Tower visible animation and terminal HUD | TOWER-01 | in-progress | Tower Ship runtime | exact reset/motion-region tests | action-ready captures | `d0034b6`, `28597ab` | terminal-state precedence fix and mask-bound evidence remain |
...
| EVID-01 | Source-frozen three-lane evidence commits | source-complete units | todo | content-addressed artifact bundles | artifact validators | Playwright correctness plus Codex physical/performance | n/a | one commit per lab/target |
