...
const directory = resolve(index >= 0 ? process.argv[index + 1] : "artifacts/visual-validation/structured-ash-growth");
const result = validateEvidenceBundle(directory);
if (!result.valid) throw new Error(`structured-Ash v2 evidence incomplete:\n- ${result.errors.join("\n- ")}`);
