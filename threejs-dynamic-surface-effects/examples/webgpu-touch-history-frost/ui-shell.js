const SHELL_STYLE = `
  ...
  aside { position: fixed; inset: 12px auto auto 12px; width: min(350px, calc(100vw - 48px)); padding: 12px; border: 1px solid #91c8ff35; border-radius: 8px; background: #081522f2; }
  header { display: flex; align-items: center; justify-content: space-between; gap: 12px; font-weight: 700; margin-bottom: 8px; }
  ...
  details { margin-top: 10px; border-top: 1px solid #91c8ff2b; padding-top: 8px; }
  summary { color: #b8c9d9; cursor: pointer; user-select: none; }
  details[open] summary { color: #e3f2ff; }
...
const SHELL_MARKUP = `
  ...
  <aside>
    <header><span>Touch-history frost</span><output data-readiness>initializing</output></header>
