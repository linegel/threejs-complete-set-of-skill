const enabled = new URLSearchParams(location.search).get("physicalReview") === "1";
...
if (enabled) {
  ...
  function record(kind, value) {
    events.push(Object.freeze({ kind, message: messageOf(value), atMs: performance.now() }));
  }
  ...
  globalThis.__THREEJS_PHYSICAL_OBSERVER__ = Object.freeze({
    installedAt,
    snapshot() {
