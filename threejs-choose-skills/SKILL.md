...
| Physics engines | No canonical pack skill owns engine selection. Keep the selected engine/domain solver authoritative internally, route only its declared Three.js presentation consumers here, and treat unsupported coupling channels as explicit blockers. |
