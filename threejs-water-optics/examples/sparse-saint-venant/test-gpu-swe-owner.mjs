...
import { buildGpuInteractionSourceData, buildGpuSweInitialData } from './gpu-swe-owner.js';
...
console.log( `GPU SWE owner contract passed: ${ initial.residentTileCount } resident tiles, ${ initial.residentCellCount } cells, ${ contract.dispatchOrder.length } ordered dispatches, one 4-cell exact-once source, 2 rejection controls` );
