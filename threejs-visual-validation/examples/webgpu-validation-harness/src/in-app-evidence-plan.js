...
export const HARDWARE_PERFORMANCE_CONTRACT = Object.freeze( {
	...
	cpuP95Maximum: numericDatum( 1000 / 60 - 2, 'ms', 'Gated', 'exact 60 Hz frame period minus 2 ms host and presentation reserve' ),
	gpuP95Maximum: numericDatum( 1000 / 60 - 2, 'ms', 'Gated', 'exact 60 Hz frame period minus 2 ms host and presentation reserve' ),
