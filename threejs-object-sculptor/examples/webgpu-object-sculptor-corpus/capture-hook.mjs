...
if (JSON.stringify(SCULPT_TARGET_IDS) !== JSON.stringify(CORPUS_CAPTURE_TARGET_IDS)) {
  throw new Error("browser-safe capture target IDs drifted from the runtime catalog");
}
