...
function fixtureLeakLoop() {
  const cycleSnapshots = Array.from({ length: 50 }, (_, index) => ({
    ...
    rendererStateBeforeDigest: canonicalSha256({ outputColorSpace: 'srgb', toneMapping: 'NeutralToneMapping' }),
    rendererStateAfterDigest: canonicalSha256({ outputColorSpace: 'srgb', toneMapping: 'NeutralToneMapping' }),
